  ...
  return (
    <div style={styles.page}>
      ...
      <section style={styles.listSection}>
        <div
          style={styles.listHeader(isMobile)}
        >
          <div
            style={styles.searchBox(isMobile)}
          >
            <span
...
const styles = {
  ...
  topAvatarPlaceholder: {
    ...
    borderRadius: "50%",
    background:
      "linear-gradient(135deg, #1f4fa3 0%, #c91f28 100%)",
    color: "#fff",
    display: "flex",
    alignItems: "center",
